      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: themeColors.text.secondary }}>
            I'm currently looking for new opportunities in Software Engineering, especially in Frontend development and healthcare tech. Whether you have a question or just want to say hi, I'll try my best to get back to you!
          </p>
        </header>
