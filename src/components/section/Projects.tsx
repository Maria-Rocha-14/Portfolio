...
import { ExternalLink, Code, Heart, ChevronLeft, ChevronRight, HeartPulse, Anchor, Plane, Factory, Leaf } from 'lucide-react';
...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Skin Lesion Gamification Web App (Internship)",
      description: "A privacy-first Progressive Web Application (PWA) for early skin lesion detection. Features offline local AI analysis via TensorFlow.js, secure historical tracking, and gamification mechanics to encourage preventive health habits.",
      technologies: ["React", "TypeScript", "PWA", "TensorFlow.js", "IndexedDB"],
      icon: HeartPulse,
      detailsUrl: "#",
      githubUrl: "https://github.com/Maria-Rocha-14/nevo.git" 
    },
    {
      title: "Port Environment Management",
      description: "A web system for port management featuring a REST API, an SPA frontend, and immersive 3D visualization.",
      technologies: ["C#", ".NET", "Angular", "TypeScript", "3D"],
      icon: Anchor,
      detailsUrl: "#", // Podes deixar "#" se não tiveres uma página de detalhes criada
      githubUrl: "https://github.com/Departamento-de-Engenharia-Informatica/LEI-SEM5-PI-2025-26-3DI-02.git" 
    },
    {
      title: "Drone Shows Management",
      description: "An application designed to manage, coordinate, and simulate drone light shows using Domain-Driven Design architecture.",
      technologies: ["Java", "DDD", "ANTLR", "GitHub Actions"],
      icon: Plane,
      detailsUrl: "#",
      githubUrl: "https://github.com/Departamento-de-Engenharia-Informatica/sem4pi-2024-2025-sem4pi_2024_2025_g42.git" 
    },
    {
      title: "Industrial Production Management",
      description: "A set of simulations built to support production planning and control in an industrial environment, integrating hardware and software.",
      technologies: ["Java", "C", "PL/SQL", "Arduino", "Raspberry Pi"],
      icon: Factory,
      detailsUrl: "#",
      githubUrl: "https://github.com/Departamento-de-Engenharia-Informatica/sem3-pi-2024_25_G092.git" 
    },
    {
      title: "Green Spaces Management",
      description: "An operational management application for urban green spaces, handling team coordination, fleet tracking, and task scheduling.",
      technologies: ["Java", "TDD", "JUnit", "Scrum"],
      icon: Leaf,
      detailsUrl: "#",
      githubUrl: "https://github.com/Departamento-de-Engenharia-Informatica/lei-24-s2-1di-g094.git" // Substitui pelo teu link
    }
  ];
                  ...
                  <div className="flex items-start gap-3">
                    {project.icon && (
                      <div className="w-12 h-12 rounded-lg flex items-center justify-center shrink-0"
                        style={{ backgroundColor: isDarkMode ? 'rgba(236, 72, 153, 0.15)' : 'rgba(253, 224, 232, 1)' }}>
                        <project.icon
